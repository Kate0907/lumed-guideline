    ...
    public static List<Item> ITEMS { get; set; } = new List<Item>
        {
            ...
            new Item { id = 82, name = "I don't know", type = ItemType.Checkbox},
            new Item { id = 83, name = "Positive", type = ItemType.Checkbox},
            new Item { id = 84, name = "Negative", type = ItemType.Checkbox},
            new Item { id = 85, name = "Never", type = ItemType.Checkbox},
            new Item { id = 86, name = "> 10 years ago", type = ItemType.Checkbox},
            new Item { id = 87, name = "1-10 years ago", type = ItemType.Checkbox},
            new Item { id = 88, name = "Days to months ago", type = ItemType.Checkbox},
            new Item { id = 89, name = "Parents or relatives", type = ItemType.Checkbox},
            new Item { id = 90, name = "Physician", type = ItemType.Checkbox},
            new Item { id = 91, name = "Nurse", type = ItemType.Checkbox},
            new Item { id = 92, name = "Pharmacist", type = ItemType.Checkbox},
